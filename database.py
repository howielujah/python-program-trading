...
FROM (SELECT 證券代號 as code, 收盤價 as closing_price, 漲跌價差 as price_difference, 成交股數 as shares_traded, 股價振幅 as stock_price_swing, 日期 as trade_date FROM daily_prices WHERE trade_date >= "{} 00:00:00" and trade_date <= "{} 00:00:00" ORDER BY trade_date DESC)
GROUP by code
